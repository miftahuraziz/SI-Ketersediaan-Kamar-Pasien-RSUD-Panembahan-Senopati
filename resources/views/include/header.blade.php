<div class="header-top">
    <div class="container">
        <div>
            <a href=""><img src="{{ asset('assets/images/logo-bantul.png') }}" alt="Logo" style="width: 8%; height: 8%; margin-left: 50px;"></a>
            <span class="d-inline"><h5>RSUD Panembahan Senopati</h5></span>
        </div>
